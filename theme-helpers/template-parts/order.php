...
<div class="row">
        <div class="give-loan-wrapper">
            <p class="give-loan-title">Как получить займ под ПТС в Москве</p>
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-12">
                        <div class="give-loan-rotat">
                            ...
                            <div class="foto-one-load-give d-flex align-items-center">
                                <img src="https://zaim-pod-zalog-pts.ru/img/load_give/load_give_arm.png" alt="">
                            </div>
                        </div>
                        <div class="arrow-load-give">
                            <img src="https://zaim-pod-zalog-pts.ru/img/arrow_loan_give/arrow_loan_give.svg" alt="">
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-12">
                        <div class="give-loan-rotat">
                            ...
                            <div class="foto-one-load-give d-flex align-items-center">
                                <img src="https://zaim-pod-zalog-pts.ru/img/load_give/load_give_car.png" alt="">
                            </div>
                        </div>
                        <div class="arrow-load-give">
                            <img src="https://zaim-pod-zalog-pts.ru/img/arrow_loan_give/arrow_loan_give.svg" alt="">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-12 ">
                        <div class="give-loan-rotat">
                            ...
                            <div class="foto-one-load-give d-flex align-items-center">
                                <img src="https://zaim-pod-zalog-pts.ru/img/load_give/liad_give_docum.png" alt="">
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-12 ">
                        <div class="give-loan-rotat">
                            ...
                            <div class="foto-one-load-give d-flex align-items-center">
                                <img src="https://zaim-pod-zalog-pts.ru/img/load_give/load_give_money.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-12 arrow-loan-rotate d-flex justify-content-center mt-2">
                            <img src="https://zaim-pod-zalog-pts.ru/img/arrow_loan_give/arrow-loan-table.svg" alt="">
                        </div>
