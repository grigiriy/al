<section>
  ...
  <div class="uk-child-width-1-2@s uk-child-width-1-5@l uk-grid-collapse uk-grid-match uk-grid" uk-grid="">
    <div class="uk-first-column">
      <a class="small-card main-bg_onhov background-f2 uk-flex uk-flex-between uk-flex-middle" href="#modal-center1">
    ...
    <div>
      <a class="small-card main-bg_onhov background-f8 uk-flex uk-flex-between uk-flex-middle" href="#modal-center1" >
