    ...
    <div class="container pt-2">
        ...
        <div class="row">
            <div class="col-xl-4 col-md-4 offset-sm-0 offset-md-2 col-sm-12">
                <p class="conditions-one-text"> <img src="https://zaim-pod-zalog-pts.ru/img/arrow.png" alt="arrow"> Сумма займа:</p>
            ...
            <div class="col-xl-4 col-md-4 offset-sm-0 offset-md-1 col-sm-12">
                <p class="conditions-one-text"> <img src="https://zaim-pod-zalog-pts.ru/img/arrow.png" alt="arrow">Срок займа: </p>
                <p class="conditions-two-text">от 1 до 36 месяцев</p>
            </div>
            <div class="col-xl-4 col-md-4 offset-sm-0 offset-md-2 col-sm-12">
                <p class="conditions-one-text"> <img src="https://zaim-pod-zalog-pts.ru/img/arrow.png" alt="arrow"> Процентная ставка: </p>
                <p class="conditions-two-text"> от 2% до 3,5% в месяц</p>
                <p class="conditions-3-text">(от 24 до 42% годовых)</p>
            </div>
            <div class="col-xl-4 col-md-4 offset-sm-0 offset-md-1 col-sm-12">
                <p class="conditions-one-text"> <img src="https://zaim-pod-zalog-pts.ru/img/arrow.png" alt="arrow">Максимальная сумма займа:
                </p>
